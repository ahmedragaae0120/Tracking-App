...
class AppStrings {
  ...
  static String get yourApplicationHasBeenSubmitted =>
      "yourApplicationHasBeenSubmitted".tr();
  static String get thankYou => "thankYou".tr();
  static String get theOrderDeliveredSuccessfully =>
      "theOrderDeliveredSuccessfully".tr();
  ...
  static String get youWantToBeaDeliveryMan => "youWantToBeaDeliveryMan".tr();
  ...
  static String get enterVehicleType => "enterVehicleType".tr();
  static String get enterVehicleNumber => "enterVehicleNumber".tr();
  static String get enterVehicleLicense => "enterVehicleLicense".tr();
  static String get enterNID => "enterNID".tr();
  static String get enterNIDImage => "enterNIDImage".tr();
  static String get enterEmail => "enterEmail".tr();
  static String get enterIDNumber => "enterIDNumber".tr();
